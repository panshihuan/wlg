...
class CalendarModifyPage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
    id = "";
    modifyData
    constructor(props) {
        super(props);
        ...
        this.id=modifyId;
        pubsub.publish("@@form.init", { id: "CalendarModifyForm", data: Immutable.fromJS(this.modifyData) })

    }


    componentDidMount() {
        if (this.modifyData.smBusiunitGidRef && this.modifyData.smBusiunitGidRef.busiUnitName) {
            pubsub.publish("smBusiunitGid.setDisplayValue", this.modifyData.smBusiunitGidRef.busiUnitName)
            console.log("**************")
        }
        ...
        return (
            <div>
                <Breadcrumb className="breadcrumb" separator=">">
                    ...
                    <Breadcrumb.Item>修改日历</Breadcrumb.Item>
                </Breadcrumb>
                                        ...
                                        behaviors: [
                                            {
                                                ...
                                                dataSource: {
                                                    type: "api",
                                                    method: "POST",
                                                    url: "/sm/calendar/modify.action?id="+this.id,
                                                    withForm: "CalendarModifyForm",
                                                },
                    ...
                    <Row>
                        <Col span={6}>
                            <Field config={{
                                ...
                                placeholder: "请选择业务单元",
                                tableInfo: {
                                    id: "smBusiunitGidFindBackTableInCalendarModifyPage",
                                    size: "small",
                                    rowKey: "gid",
                                    width: 300,
                                    tableTitle: "业务单元",
