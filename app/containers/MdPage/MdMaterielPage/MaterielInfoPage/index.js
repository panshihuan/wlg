...
export class MaterielInfoPage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
    ...
    constructor(props) {
        ...
        if(this.props.location.state.treeData!=undefined){

            console.log(this.props.location.state.treeData)
            let  treeData = {};
            treeData["materielTypeGidRef"] = {};
            treeData["materielTypeGidRef"].name = this.props.location.state.treeData.nodeName;
            treeData.materielTypeGid  = this.props.location.state.treeData.nodeGid;
            //console.log(treeData)
            pubsub.publish("@@form.init", { id: "MaterielInfoPage", data: treeData})
            //pubsub.publish("@@form.change", { id: "MaterielInfoPage", name:"materielTypeGid",data:treeData.treeGid })
                    ...
                    <Row>
                        <Col span={8} xs={24}>
                            <AppButton config={{
                                ...
                                subscribes: [
                                    {
                                        event: "mdMaterielInfo0101.click",
                                        behaviors: [
                                            {
                                                type: "request",
                                                dataSource: {
                                                    type: "api",
                                                    method: "POST",
                                                    url: "/ime/mdMaterielInfo/add.action",
                                                    withForm: "MaterielInfoPage"
...
let MaterielInfoPageForm =  reduxForm({
    form: "MaterielInfoPage",
    validate,
    asyncValidate,
    asyncBlurFields: ['code']
})(MaterielInfoPage)
export default connect(mapStateToProps, mapDispatchToProps)(MaterielInfoPageForm);
