...
//     }
//
//     let className = "com.neusoft.ime.md.mdProductInfo.dto.MdProductInfoDTO";
                                  ...
                                  behaviors: [
                                      {
                                          ...
                                          dataSource: {
                                              type: "api",
                                              method: "POST",
                                              url: "/ime/mdProductInfo/add.action",
                                              withForm: "Create",
                                          },
          ...
          <Card style={{ width: "100%", backgroundColor: "#f9f9f9", marginTop: "15px" }} bodyStyle={{ padding: "15px" }}>
                                      ...
                                      meta: {
                                          expression: `
                                             resolveFetch({fetch:{id:'materialGidRef.name',data:'dataContext'}}).then(function(value){
                                                ...
                                                if(value){
                                                    pubsub.publish("@@form.change", { id: "Create", name:"materialGidRef.code", value: "" })
                                                    pubsub.publish("@@form.change", { id: "Create", name:"materialGidRef.name", value: "" })
                                                    pubsub.publish("@@form.change", { id: "Create", name:"materialGidRef.measurementUnitGidRef.name" , value: "" })
                                                    pubsub.publish("@@form.change", { id: "Create", name:"materialGidRef.spec", value: "" })
                                                    pubsub.publish("@@form.change", { id: "Create", name:"materialGidRef.model", value: "" })
                                                    pubsub.publish("@@form.change", { id: "Create", name:"materialGidRef.figureNumber", value: "" })
                                                }
              ...
              <Row>
                  <Col span={6}>
                      ...
                      }} component={FindbackField} name="routePath" />
                  </Col>
                  <Col span={6}>
                      <Field config={{
                          enabled: false,
                                          ...
                                          pubs:[
                                              {
                                                 ...
                                                 //                value=data.isPivotal
                                                 //            }
                                                 //            console.log("value",value)
                                                 //            pubsub.publish("productCancel1.dataContext",{
                                                 //                    eventPayload:value
                                                 //            });
                                                 //            console.log("productCancel1.dataContext",value)
                                                 //        })
                                                 //        callback(111)
                                                 // `
                                              },
                                              ...
                                              //           resolveFetch({fetch:{id:'productCancel1',data:'dataContext'}}).then(function(data2){
                                          ...
                                          subscribes:[
                                              {
                                                  ...
                                                  pubs:[{
                                                      ...
                                                      meta:{
                                                          expression:`
                                                          console.log(111111)
                                                      resolveFetch({fetch:{id:'Create',data:'@@formValues'}}).then(function(dt){
                                                      console.log(dt)
                                                                     let dataSource={
                                                                      type: 'api',
                                                                      method: 'post',
                                                          ...
                                                          meta:{
                                                              expression: `
                                                                    ...
                                                                    if( bomGid.gid=="56EE122D4E275E53E055000000000001"){
                                                                        ...
                                                                        pubsub.publish("@@form.change", { id: "Create", name:me.props.input.name, value: val2 })
                                                                    }
                                                              `
                                                          }
                                                      },
