...
export class DataTemplatePageModify extends React.PureComponent {
    //构造
    constructor(props) {
        super(props);
        ...
        let dataSource = {
            ...
            type: "api",
            method: "POST",
            url: "/sm/dcDataTemplate/findById.action?id="+modifyId,
            payload: {
                id: modifyId
            }
        }
        ...
        resolveDataSource({dataSource}).then(function (data) {
           ...
           // pubsub.publish("@@form.change",  { id: "BusiGroupPage",name:"busiGroupName" ,value: "" })
            ...
            pubsub.publish("@@form.init", {id: "DataTemplatePageModify", data: Immutable.fromJS(modifyData)})
        });
        ...
        let dataSource2 = {
            ...
            method: 'post',
            mode:"payload",
            url: '/sm/dcDataTemplateDetail/query.action',
            payload:{
                "query": {
                    "query": [
                        {
                            "field": "dcDataTemplateGid",
                            "type": "eq",
                            "value": modifyId
                        }
                    ]
        ...
        resolveDataSource({
            ...
            console.log(data)
            var modifyData = data.data
            pubsub.publish("@@form.change",  { id: "DataTemplatePageModify",name:"tableFiled121223" ,value: Immutable.fromJS(modifyData)})
        ...
        return (
            <div>
                <Breadcrumb className="breadcrumb">
                    ...
                    <Breadcrumb.Item>修改采集模板</Breadcrumb.Item>
                </Breadcrumb>
                                        ...
                                        pubs: [
                                            {
                                                ...
                                                meta: {
                                                    ...
                                                    resolveFetch({fetch:{id:"DataTemplatePageModify",data:"@@formValues"}}).then(function (value) {
                                                                    ...
                                                                    let dataSource= {
                                                                      type: "api",
                                                                      method: "POST",
                                                                      url: "/sm/dcDataTemplate/modify.action?id="+value.gid
                                                                    };
                                                                                ...
                                                                                if(typeof(tabarr) != "undefined"){
                                                                                       ...
                                                                                       for(let i = 0;i < tabarr.length;i++){
                                                                                            let dataSource1= {
                                                                                              type: "api",
                                                                                              method: "POST",
                                                                                              url: "/sm/dcDataTemplateDetail/modify.action?id="+tabarr[i].gid
                                                                                            };
...
DataTemplatePageModify.propTypes = {
