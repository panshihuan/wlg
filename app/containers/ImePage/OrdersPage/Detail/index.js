...
const asyncValidate = values => {
    ...
    let className = "com.neusoft.ime.produce.imePlanOrder.dto.ImePlanOrderDTO"
...
class Detail extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  ...
  constructor(props) {
    ...
    pubsub.publish("@@form.init", { id: "detail", data: {"planOrderTypeGid":"56B22149453D4BE1E056000000000001"} })
  ...
  componentWillUnmount() {
    pubsub.unsubscribe("tafnjnjdkkdllooeop30jsodojw4jh777frr.onSelectedRows")
    pubsub.unsubscribe("addChange")
    pubsub.unsubscribe("openData")
  }
                ...
                subscribes: [
                  {
                    ...
                    pubs: [
                      ...
                      pubsub.publish("@@form.change", { id: "detail",name:"imePlanOrderDetailDTOs" ,value:fromJS(mdData)})
                ...
                subscribes:[
                  {
                    ...
                    pubs:[
                      {
                        event:"realNum.expression",
                        meta: {
                          expression: `
                            let da = data.eventPayload
                            pubsub.publish("@@form.change", { id: "detail", name: "actualQty", value: da })
                          `
                        }
                      }
                    ]
          ...
          <Row>
            <Col span={6}>
              <Field config={{
                ...
                wrapperSpan: 16,  //输入框栅格比例（0-24）
                placeholder: "根据规则回写"
              }} component={TextField} name="orderStatusGid" />
            </Col>
            <Col span={6}>
              <Field config={{
                enabled: false,
                     ...
                     /* pubs: [
                        {
                          ...
                          meta: {
                            expression: `
                            resolveFetch({fetch:{id:'workLine',data:'dataContext'}}).then(function(dt){
                             if(dt==undefined)
                              {
          ...
          <Row>
            ...
            <Col span={6}>
              <Field config={{
                ...
                wrapperSpan: 16,  //输入框栅格比例（0-24）
                placeholder: "根据规则回写"
              }} component={TextField} name="bomStatusGid" />
            </Col>
          </Row>
          ...
          <Row>
            ...
            <Col span={6}>
              <Field config={{
                ...
                wrapperSpan: 16,  //输入框栅格比例（0-24）
                placeholder: "根据规则回写"
              }} component={TextField} name="processStatus" />
            </Col>
          </Row>
        </Card>
        <Card style={{ width: "100%", backgroundColor: "#f9f9f9", marginTop: "15px" }} bodyStyle={{ padding: "15px" }}>
          <Tabs defaultActiveKey="1">
            <TabPane tab="子物料" key="1">
              <Row type="flex" justify="space-between">
                ...
                subscribes:[
                  {
                    ...
                    pubs:[
                      {
                        event:"tafnjnjdkkdllooeop30jsodojw4jh777frr.addRow"
                      }
                    ]
                  }
                ]
                ...
                subscribes:[
                  {
                    event:"tafnjnjdkkdllooeop30jsodojw4jh777frr.onSelectedRows",
                    pubs:[
                          {
                            event:"tafnjnjdkkdllooeop30jsodojw4jh777frr.expression",
                            meta:{
                              expression:`
                                let index
                    ...
                    behaviors:[
                      {
                        type:"fetch",
                        id:"tafnjnjdkkdllooeop30jsodojw4jh777frr",
                        data:"selectedRows",
                        successPubs:[
                          {
                    ...
                    "columns": [
                      ...
                      , {
                       ...
                       "enabled": false
                        ...
                        subscribes:[
                          {
                            event:"tableFiled7.onChange",
                            pubs:[
                              {
                                event:"tableFiled8.expression",
                                meta: {
                                  expression: `
                            ...
                            pubs:[
                              {
                                ...
                                meta: {
                                  expression: `
                                  let pnum = parseInt(data.eventPayload)
                                    resolveFetch({fetch:{id:'tableFiled7['+me.props.config.rowIndex+']',data:'props'}}).then(function(data){
                                      if(!data.input.value){
                                        data.input.value = 0
                                      }
                                      let num = parseInt(data.input.value)
                      ...
                      },
                      {
                        ...
                        "id": "tableFiled8jjkfffffkooopppddsxcwjkk7udlaiyuan",
                        "type": "findbackField",
                        "title": "来源仓库",
                        "form": "detail",
                        "name": "wareHouseGidRef.warehouseName",
                        tableInfo: {
                          id: "tapdjbdvcbndxsfffffe44ffsvgfddslaiyuan",
                          size: "small",
                          rowKey: "gid",
                          width: "500",
                          tableTitle: "来源仓库",
                        ...
                        pageId: 'tableFijofffffsoodooddlaiyuan',
                        ...
                        "id": "tableFiled8jjkkfffffoogongxuxcwjkk7ud",
                        "type": "findbackField",
                        "title": "工序",
                        "form": "detail",
                        ...
                        subscribes: [
                          {
                              event:"tapdjbdvcbndfffffddssxgongxuvgfdds.onTableTodoAny",
                              pubs:[
                                {
                                  event:"tapdjbdvcbndfffffddssxgongxuvgfdds.expression",
                                  meta: {
                              expression:`
                        ...
                        tableInfo: {
                          id: "tapdjbdvcbndfffffddssxgongxuvgfdds",
                          size: "small",
                          rowKey: "gid",
                          width: "100",
                          tableTitle: "工序",
                        ...
                        pageId: 'tableFgongxuoffffffdoodd',
                        displayField: "name",
                        valueField: {
                          "from": "name",
                        ...
                        "id": "tableFigongweiohhhhjjyypppddsxcwjkk7ud",
                        "type": "findbackField",
                        "title": "工位",
                        "form": "detail",
                        ...
                        subscribes:[
                          {
                            event:"tapdjbdvgonffdddgwei4ffsvg2222ddfffdds.onTableTodoAny",
                            behaviors: [
                        {
                          type: "fetch",
                          ...
                          successPubs: [  //获取数据完成后要发送的事件
                            {
                              event: "tapdjbdvgonffdddgwei4ffsvg2222ddfffdds.loadData",
                              eventPayloadExpression:`
                              let payload ={}
                              let field
                              let gid 
                        ...
                        tableInfo: {
                          id: "tapdjbdvgonffdddgwei4ffsvg2222ddfffdds",
                          size: "small",
                          rowKey: "gid",
                          tableTitle: "工位",
                          width: "500",
                        ...
                        pageId: 'tablegongddddwertttweiod2222oodd',
                        ...
                        "id": "tableFilgongyiluxiafffffceernsxcwjkk7ud",
                        "type": "findbackField",
                        "title": "工艺路线",
                        "form": "detail",
                        "name": "technicsGidRef.name",
                        tableInfo: {
                          id: "tapdjbdgongyilugdd222ne44ffsvgfdds",
                          size: "small",
                          rowKey: "gid",
                          tableTitle: "工艺路线",
                          width:100,
                        ...
                        pageId: 'tablegongyiluxiadddewsndo2222odd',
                        displayField: "routeLineName",
                        valueField: {
                          "from": "routeLineName",
                        ...
                        "id": "tableSezhuisuddfffffffff1ddftrrrefsadew43",
                        "type": "selectField",
                        "title": "追溯",
                        "name": "reviewGid",
                        dataSource: {
                          ...
                          expression:`
                            ...
                            resolveFetch({fetch:{id:'detail',data:'@@formValues'}}).then(function(res){
                              if(!res.imePlanOrderDetailDTOs){
                                pubsub.publish("@@form.change", { id: "detail",name:"imePlanOrderDetailDTOs" ,value: fromJS(me.dataContext) })
                                pubsub.publish("pageIdDidddssRecordteeeeeeeffgg.onCancel")
                                }else{
                                  let imeArr = res.imePlanOrderDetailDTOs.concat(me.dataContext)
                                pubsub.publish("@@form.change", { id: "detail",name:"imePlanOrderDetailDTOs" ,value: fromJS(imeArr) })
                                pubsub.publish("pageIdDidddssRecordteeeeeeeffgg.onCancel")
                                }
                            })
                          `
