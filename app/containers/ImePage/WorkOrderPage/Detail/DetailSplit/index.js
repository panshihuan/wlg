                          ...
                          expression:`
                            ...
                            if(!reg.test(resd.materialNumber)){
                              ...
                              pubsub.publish("@@message.error","输入的数量必须小于拆分前的数量,请重新输入")
                                ...
                                let index 
                                let resda = resd
                          resolveFetch({fetch:{id:'tafnjnjdkkdllow4jh777frr',data:'dataContext'}}).then(function(res){
                            index = res
                          })
                          resolveFetch({fetch:{id:'detail',data:'@@formValues'}}).then(function(res){
                            ...
                            pubsub.publish("@@form.change", { id: "detail",name:"imeWorkOrderDetailDTOs" ,value: fromJS(res.imeWorkOrderDetailDTOs) })
