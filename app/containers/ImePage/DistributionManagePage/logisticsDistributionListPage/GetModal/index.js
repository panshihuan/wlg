...
export class GetModal extends React.PureComponent {
                        ...
                        <TabPane tab="物流派工单" key="1-1">
                            <AppTable name="sendModal-tableField-1" config={{
                                ...
                                "columns": [
                                    ...
                                    {title: '供应仓库', dataIndex: 'mdWarehouseGidRef.name', key: '3', width: 150},
                                                        ...
                                                        expression: `
                                                            resolveFetch({fetch:{id:'logistics-dist-grid-index',data:'selectedRows'}}).then(function(pd){
                                                                ...
                                                                resolveDataSourceCallback({ dataSource:dataSource,eventPayload:{deliveryId:pd}},
                                                                    function (data) {
                                                                            pubsub.publish("@@form.init",{id:"GetModalForm",data:{aaa:data.data}})
                                                                    }
                                                                )
                                                            })
                                                        ...
                                                        expression: `
                                                            resolveFetch({fetch:{id:'logistics-dist-grid-index',data:'selectedRows'}}).then(function(pd){
                                                                ...
                                                                let arr=[];
                                                                    ...
                                                                    resolveFetch({fetch:{id:'GetModalForm',data:"@@formValues"}}).then(function(vals){
                                                                        if(vals['SendModal-radio-1']){
                                                                            resolveDataSourceCallback({ dataSource:dataSource,eventPayload:{deliveryId:pd,trackIds:arr}},
                                                                                function (data) {
                                                                                        pubsub.publish("@@form.init",{id:"GetModalForm",data:{"SendModal-radio-1":vals['SendModal-radio-1'],aaa:data.data}})
                                                                                }
                                                                            )
                                                                        }else{
                                                                            resolveDataSourceCallback({ dataSource:dataSource,eventPayload:{deliveryId:pd,trackIds:arr}},
                        ...
                        subscribes: [
                            {
                                ...
                                pubs:[{
                                    event: "logistics-modal-3.onCancel",
                                }]
                            }
                        ]
                    }} />
                                ...
                                pubs: [
                                    {
                                        eventPayloadExpression: `
                                             let radio;
                                             resolveFetch({fetch:{id:'GetModalForm',data:'@@formValues'}}).then(function(py){
                                ...
                                pubs:[
                                    {
                                        eventPayloadExpression:`
                                            let dataSource={
                                                ...
                                                method:'post',
                                                mode:'dataContext',
                                                url:'/ime/imeLogisticsDelivery/receivingByTrackIdsSubmit.action',
                                            }
                                            ...
                                            let dataSource2={
                                                ...
                                                method:'post',
                                                mode:'dataContext',
                                                url:'/ime/imeLogisticsDelivery/receivingSubmit.action',
                                            }


                                                //按物流派工单收货
                                                resolveFetch({fetch:{id:'GetModalForm',data:'@@formValues'}}).then(function(pd){
                                                 ...
                                                 //按明细收货
                                                        if(pd['SendModal-radio-1']=="2"){
                                                            if(!submitValidateForm('GetModalForm')){
                                                                resolveFetch({fetch:{id:'GetModalForm',data:'@@formValues'}}).then(function(pd){
                                                                    if(pd['SendModal-radio-1']){
                                                                        if(pd['SendModal-radio-1']=="2"&&pd.aaa&&pd.aaa.length){
                                                                            ...
                                                                            _.map(pd.aaa,function(item,index){
                                                                                let obj={};
                                                                                obj.id=item.gid;
                                                                                obj.receiveQty=item.deliveryQty2||null;
                                                                                arr.push(obj)
                                                                            })
...
let GetModalFormLet =reduxForm({
    form: "GetModalForm",
    validate,
})(GetModal);

export default connect(mapStateToProps, mapDispatchToProps)(GetModalFormLet);